...
namespace JWTPlay2.Identity
{
    public class CustomOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = context.OwinContext.Get<PizzaSalesEntities>().Users.FirstOrDefault(u => u.username == context.UserName);
        ...
        private static System.Security.Claims.ClaimsIdentity SetClaimsIdentity(OAuthGrantResourceOwnerCredentialsContext context, User user)
        {
            ...
            //var userRoles = context.OwinContext.Get<BookUserManager>().GetRoles(user.user_id);
